...
namespace CustomShops.Shops
{
    public class BlackMarketShop : TaggedShop, IDiscountFromFaction, IFillWidgetFromFaction, ISaveShop, ITextIcon, IDefaultPrice
    {
        ...
        public override bool CanUse => Control.Settings.DEBUG_FactionShopAlwaysAvaliable || (Control.State.CurrentSystem != null && Control.State.Sim.CompanyTags.Contains(Control.State.Sim.Constants.Story.BlackMarketTag));
